...
for fn in sorted(glob.glob('*.ipynb')):
    if fn[0] in 'qwertyuiopasddfghjklzxcvbnm' and not switched:
        switched=True
        out.write('## Packages\n')
    out.write('### [{f}](https://github.com/hoihui/tutorial/blob/master/{f}) [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/hoihui/tutorial/blob/master/{f}) [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/hoihui/tutorial/master?filepath={f})\n'.format(f=fn))
